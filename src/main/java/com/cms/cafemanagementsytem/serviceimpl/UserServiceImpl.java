package com.cms.cafemanagementsytem.serviceimpl;

import com.cms.cafemanagementsytem.constents.CafeConstants;
import com.cms.cafemanagementsytem.dao.UserDao;
import com.cms.cafemanagementsytem.pojo.User;
        ...
        try {
            ...
            if (validateSignUpMap(requestMap)) {
                ...
                if (Objects.isNull(user)) {
                    ...
                    return CafeUtils.getResponseEntity("Email arleady exists", HttpStatus.BAD_REQUEST);
                }
